...
## Radix Sort
Works on list of numbers, never makes comparsions between elements.

Create ten different buckets, look at last digit of each number and group them into buckets based on that number. Then move onto next digit.
